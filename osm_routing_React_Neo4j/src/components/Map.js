...
//Logos lors des clicks (debut & end) 
var selected_start = new mapboxgl.Marker({ color: "green", zIndexOffset: 9999 });
var selected_end = new mapboxgl.Marker({ color: "bleu", zIndexOffset: 9999 });
...
/*       this.map.addLayer({
      ...
      this.map.on("click", "points", e => {
        ...
        if (this.selectingStart) {
			//Logos lors des clicks (debut) 
		  selected_start.setLngLat([coordinates[0], coordinates[1]]).addTo(this.map);	
          ...
          this.props.setStartAddress(name);
			...
			//Logos lors des clicks (end) 
		  selected_end.setLngLat([coordinates[0], coordinates[1]]).addTo(this.map);
